document.addEventListener('DOMContentLoaded', function() {
    ...
    closeButton.addEventListener('click', function() {
        ...
        if (!document.getElementById('show-terminal')) {
            ...
            document.querySelector('.quote-section').after(showButton);
...
<div class="skill-item"><strong>Programming:</strong> Expert level across multiple languages (20+ years)</div>
<div class="skill-item"><strong>Web Development:</strong> Full-stack capabilities</div>
<div class="skill-item"><strong>Blockchain:</strong> Cryptocurrency mining, token development</div>
<div class="skill-item"><strong>AI:</strong> Keeping up with the latest developments</div>
<div class="skill-item"><strong>Architecture:</strong> System design and optimization</div>
</div>`;
        },
